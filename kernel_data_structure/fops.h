...
extern ssize_t orange_write(struct file *filp, const char __user *buff, size_t count, loff_t *offp);
extern void orange_trim(struct orange_dev *dev);
extern void orange_print_list(struct orange_dev *dev);
